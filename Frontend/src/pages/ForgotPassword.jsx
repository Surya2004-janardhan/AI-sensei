        ...
        {step === 1 ? (
          ...
          <form onSubmit={handleResetPassword} className="space-y-5">
            ...
            <input
              ...
              maxLength={6}
              className="w-full px-4 py-3 border border-black/40 rounded-md text-black placeholder-black/60 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-1 text-center text-2xl tracking-widest font-bold transition-all"
              required
              disabled={loading}
            />
